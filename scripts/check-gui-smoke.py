...
for name in ["artwork-light", "artwork-dark", "help-light", "device-light", "confirmation-dark", "compact-light"]:
...
print("Six native GUI views captured: light/dark, help, device, confirmation, compact.")
